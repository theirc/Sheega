...
export const COMMON_DYNAMIC_CONTENT_PLACEHOLDERS = [
  ...
  'signpost_sheega_mission_statement',
];
...
export const HOME_PAGE_DYNAMIC_CONTENT_PLACEHOLDERS = [
  ...
  'default_banner_whatsapp_title',
  'signpost_sheega_facebook_link',
  'signpost_sheega_messenger_link',
  // Main body strings.
  'default_information_title',
  'signpost_sheega_information_description',
...
export function populateSocialMediaLinks(dynamicContent: {
  ...
  return {
    facebookLink: {
      ...
      href: dynamicContent['signpost_sheega_facebook_link'],
    },

    messengerLink: {
      title: dynamicContent['default_banner_messenger_title'],
      href: dynamicContent['signpost_sheega_messenger_link'],
    },
  };
}
...
export function populateHeaderBannerStrings(dynamicContent: {
  ...
  return {
    welcomeTitle: dynamicContent['signpost_sheega_mission_statement'],
...
export function populateCategoriesSectionStrings(dynamicContent: {
  ...
  return {
    ...
    description: dynamicContent['signpost_sheega_information_description'],
  };
}
